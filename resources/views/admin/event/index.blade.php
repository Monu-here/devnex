...
@section('admin_title', 'AMFL| Event')
@section('css')
...
@section('content')
    ...
    <a href="{{route('admin.event.add')}}"   class="btn btn-primary btn-sm" style="float: right; margin: 10px;" >
        Create New
    </a>
...
@section('js')
    ...
    <script>
        $(document).ready(function() {
            var $urls = '{{ route('admin.event.fetchData') }}';
            $('#table').DataTable({
                serverSide: true,
                searching: true,
                pageLength: 10,
