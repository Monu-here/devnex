...
<head>
    ...
    <title>Devnex : Build Your Project With Us</title>
            ...
            <div class="row">
                <div class="col-12">
                    <nav class="main-nav">
                        ...
                        <a href="#" class="logo">
                            DEVNEX
                            {{-- <img src="{{asset('assets/image/logo copy.png')}}" alt="Softy Pinko" /> --}}
                        </a>
                        <!-- ***** Logo End ***** -->
                        <!-- ***** Menu Start ***** -->
                        <ul class="nav">
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-5 col-md-12 col-sm-12 align-self-center"
                    ...
                    <img src="{{asset('assets/image/left-image.png')}}" class="rounded img-fluid d-block mx-auto" alt="App">
                </div>
